...
public class Children_level_1 implements Parcelable {
    ...
    public String categoryName; // ex: "流行男鞋"
    ...
    public Children_level_1(Parcel src){
        ...
        src.readTypedList(childrenList, Children_level_2.CREATOR);
    }
    @Override
    ...
    public static final Creator<Children_level_1> CREATOR = new Creator<Children_level_1>() {
        @Override
        public Children_level_1 createFromParcel(Parcel in) {
            return new Children_level_1(in);
        }

        @Override
        public Children_level_1[] newArray(int size) {
            return new Children_level_1[size];
        }
    };
