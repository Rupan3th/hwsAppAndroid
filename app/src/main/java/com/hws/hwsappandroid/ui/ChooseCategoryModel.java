...
public class ChooseCategoryModel extends ViewModel {
    ...
    public void loadData(String categoryId, int level) {
        if (isLoading) return;
        isLoading = true;
        new Handler().post(new Runnable() {
            ...
            public void run() {
                ...
                String url = "/sysCategory/queryByCategory";
...
//                        Toast.makeText(mContext, res.getString(R.string.error_db), Toast.LENGTH_SHORT).show();
    ...
    public void loadMoreGoods(String categoryCode, int level, int pageNum) {
        if (isLoading) return;
        isLoading = true;
