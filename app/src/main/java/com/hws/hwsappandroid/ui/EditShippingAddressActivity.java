...
//                                startActivity(i);
    ...
    public void validateCheck(){
        if(consigneeName.getText().toString().equals("")){
            ...
            builder.setMessage(getResources().getString(R.string.enter_consignee_name));
            builder.create().show();
            return;
        }
        if(phone_number.getText().toString().equals("")){
            validate = false;
            AlertDialog.Builder builder = new AlertDialog.Builder(EditShippingAddressActivity.this);
            builder.setMessage(getResources().getString(R.string.enter_phone_number));
            builder.create().show();
            return;
        }else {
            if(!isMobileNO(phone_number.getText().toString())){
                validate = false;
                AlertDialog.Builder builder = new AlertDialog.Builder(EditShippingAddressActivity.this);
                builder.setMessage(getResources().getString(R.string.enter_correct_phone));
                builder.create().show();
                return;
            }
        }
        if(detailed_address.getText().toString().equals("")){
            validate = false;
            AlertDialog.Builder builder = new AlertDialog.Builder(EditShippingAddressActivity.this);
            builder.setMessage(getResources().getString(R.string.enter_detailed_address));
            builder.create().show();
            return;
        }
        if(address_p.getText().toString().equals("")){
            validate = false;
            AlertDialog.Builder builder = new AlertDialog.Builder(EditShippingAddressActivity.this);
            builder.setMessage(getResources().getString(R.string.select_a_city));
            builder.create().show();
            return;
        }
    }
