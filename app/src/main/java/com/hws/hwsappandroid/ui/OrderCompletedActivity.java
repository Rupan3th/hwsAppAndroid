...
public class OrderCompletedActivity extends AppCompatActivity  implements ItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        service_center.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent SC = new Intent(OrderCompletedActivity.this, ServiceMessagesActivity.class);
        ...
        view_logistics = findViewById(R.id.view_logistics);
...
//            client_info.setText(orderDetail.consignee + ", " + orderDetail.phone + ", " + orderDetail.address);
            ...
            adapter = new OrderGoodsListAdapter(this,true);
        ...
        shop_info.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent SD = new Intent(OrderCompletedActivity.this, StoreDetailsActivity.class);
        ...
        copyBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                setClipboard(OrderCompletedActivity.this, orderCode.getText().toString());
                Toast.makeText(OrderCompletedActivity.this, "copied "+ orderCode.getText().toString(), Toast.LENGTH_SHORT).show();
            }
        });
...
//                    Log.i("Home", ""+scrollY+","+v.getMeasuredHeight()+","+v.getChildAt(0).getMeasuredHeight());
        ...
        view_logistics.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent LI = new Intent(OrderCompletedActivity.this, LogisticsInformationActivity.class);
                LI.putExtra("orderId", orderId);
                startActivity(LI);
//                showLogisticsDialog();
            }
        });
