...
//                    model.loadMoreGoods();
        ...
        ImageView gotoStoreBtn = findViewById(R.id.gotoStoreBtn);
        gotoStoreBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    private void showBottomSheetDialog() {
        ...
        TextView tvItemAmount = bottomSheetDialog.findViewById(R.id.tvItemAmount);
        Button plusBtn = bottomSheetDialog.findViewById(R.id.btnPlus);
        ...
        Button minusBtn = bottomSheetDialog.findViewById(R.id.btnMinus);
        ...
        confirmBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(!buy_now_sate) {
                    ...
                    bottomSheetDialog.dismiss();
                    Intent detailImage = new Intent(getApplicationContext(), MyOrderActivity.class);
