...
public class EmotionInputDetector {
    ...
    public EmotionInputDetector bindAttachButton(View contentView) {
        mAttachButton = contentView;
        return this;
    }

    public EmotionInputDetector bindToEditText(EditText editText) {
        mEditText = editText;
        editText.addTextChangedListener(new EditWatcher(mSendButton, mAttachButton, editText));
